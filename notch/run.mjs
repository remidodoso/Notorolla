...
// simulator), meter-bosh.mjs (a metering rig, not a pass/fail test) and this
// runner are skipped. Tests import the live ../src directly — no copy step
...
const skip = new Set(['run.mjs', 'wasim.mjs', 'meter-bosh.mjs']);
